...
{
      fprintf(stderr,"Usage: generate_bmp_for_coupled_microstrip [-b bmp_size] [-v] w s g h t Er1 Er2 filename\n\n");
      ...
      fprintf(stderr,"<-----------------------------------W----------------------------------->\n\n");
      fprintf(stderr,"E.g. \ngenerate_bmp_for_coupled_microstrip 1.5 2.0 1 1.593 0.035 1 3.7 foo.bmp\n\n");
