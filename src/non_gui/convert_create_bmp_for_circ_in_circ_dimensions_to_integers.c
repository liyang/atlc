...
int convert_create_bmp_for_circ_in_circ_dimensions_to_integers(int accuracy_level) 
{
   ...
   lowest*=(int) 0.5+sqrt(pow(2,accuracy_level));
   highest*=(int) 0.5+sqrt(pow(2,accuracy_level));
